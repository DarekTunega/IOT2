  ...
  useEffect(() => {
    ...
    const fetchBuildingDetails = async () => {
      ...
      try {
        ...
        setBuilding({ id: data.id, name: data.name, userId: data.userId });
      ...
      <div className="ml-64 flex-1 p-6">
        ...
        <div className="space-y-8 max-w-7xl mx-auto">
          {devices.length === 0 ? (
            ...
            devices.map(device => (
              <Card key={device.id} className="p-6 space-y-6">
                  <CO2StatsCards
                  ...
                  <div className="h-[350px]">
                     {device.readings && device.readings.length > 0 ? (
                        ...
                        <div className="flex items-center justify-center h-full text-gray-500">No reading data available for graph.</div>
                     )}
                  </div>
